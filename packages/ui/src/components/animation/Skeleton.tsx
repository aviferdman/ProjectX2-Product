...
export const Skeleton = forwardRef<HTMLDivElement, SkeletonProps>(
  (
    ...
    if (variant === 'text' && lines > 1) {
      return (
        <div ref={ref} className={clsx('cs-skeleton-group', className)} role="status" aria-label="Loading" {...rest}>
          {Array.from({ length: lines }, (_, i) => (
            <div
              key={i}
              className={clsx(
                'cs-skeleton cs-skeleton--text',
              ...
              style={{
                ...
                background: 'linear-gradient(90deg, rgba(113,113,122,0.08) 25%, rgba(113,113,122,0.16) 50%, rgba(113,113,122,0.08) 75%)',
