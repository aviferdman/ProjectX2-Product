...
export interface MarketplacePaginationProps extends Omit<
...
export const MarketplacePagination = forwardRef<HTMLElement, MarketplacePaginationProps>(
  function MarketplacePagination({ currentPage, totalPages, onChange, className, ...props }, ref) {
