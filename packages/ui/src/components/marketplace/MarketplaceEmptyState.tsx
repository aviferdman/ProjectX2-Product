...
export const MarketplaceEmptyState = forwardRef<
  HTMLDivElement,
    ...
    >
      ...
      <div className="mb-4">
        <svg
          ...
          aria-hidden="true"
        >
          <rect x="16" y="12" width="40" height="40" rx="10" stroke="currentColor" strokeWidth="1.5" />
          <path d="M28 32h16M36 24v16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
