...
export interface MarketplaceCategoryFilterProps extends Omit<
...
export const MarketplaceCategoryFilter = forwardRef<HTMLDivElement, MarketplaceCategoryFilterProps>(
