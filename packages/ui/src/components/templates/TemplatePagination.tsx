...
export interface TemplatePaginationProps extends Omit<
...
export const TemplatePagination = forwardRef<HTMLElement, TemplatePaginationProps>(
  function TemplatePagination({ currentPage, totalPages, onChange, className, ...props }, ref) {
