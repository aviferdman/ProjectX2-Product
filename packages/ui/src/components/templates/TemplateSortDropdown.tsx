...
export interface TemplateSortDropdownProps extends Omit<
...
export const TemplateSortDropdown = forwardRef<HTMLDivElement, TemplateSortDropdownProps>(
  function TemplateSortDropdown({ value, onChange, className, ...props }, ref) {
    const [open, setOpen] = useState(false);
    const containerRef = useRef<HTMLDivElement>(null);

    const activeLabel = SORT_OPTIONS.find((o) => o.field === value.field)?.label ?? 'Sort';
