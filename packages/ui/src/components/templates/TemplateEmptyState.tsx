...
export interface TemplateEmptyStateProps extends React.HTMLAttributes<HTMLDivElement> {
  heading?: string;
  description?: string;
...
export const TemplateEmptyState = forwardRef<HTMLDivElement, TemplateEmptyStateProps>(
  function TemplateEmptyState(
    ...
    return (
      ...
      >
        ...
        <h3 className="text-tpl-empty-heading text-[var(--cs-text-primary)] mb-2">{heading}</h3>
