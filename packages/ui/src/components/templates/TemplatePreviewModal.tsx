...
export interface TemplatePreviewModalProps extends Omit<
...
export const TemplatePreviewModal = forwardRef<HTMLDivElement, TemplatePreviewModalProps>(
  function TemplatePreviewModal({ template, onClose, onUseTemplate, className, ...props }, ref) {
      ...
      <Overlay onClose={onClose}>
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-slate-700 px-5 py-3">
            <h2 className="text-lg font-semibold text-slate-100 truncate">{template.name}</h2>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
            ...
            {/* Workflow diagram */}
            <div>
              <h3 className="text-sm font-medium text-slate-200 mb-2">Workflow</h3>
