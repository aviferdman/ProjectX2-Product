  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-tpl-card-body-p">
        ...
        {/* Title */}
        <h3 className="text-tpl-card-title text-tpl-card-title truncate">{template.name}</h3>

        {/* Description */}
        <p className="text-tpl-card-desc text-tpl-card-desc line-clamp-2">{template.description}</p>
