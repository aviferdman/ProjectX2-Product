...
export interface TemplateGridProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'children'> {
  templates: TemplateSummary[];
  onUseTemplate?: ((id: string) => void) | undefined;
  onPreview?: ((id: string) => void) | undefined;
}

export const TemplateGrid = forwardRef<HTMLDivElement, TemplateGridProps>(function TemplateGrid(
