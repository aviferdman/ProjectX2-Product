        ...
        {filtered.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center animate-fadeIn">
            ...
            <p className="text-sm text-[var(--cs-text-tertiary)] max-w-sm mb-6">
              Describe your first initiative on the home page and CrewSpace will assemble a crew for
              you.
            </p>
            <button
              onClick={() => navigate('/')}
              className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium transition-all shadow-lg shadow-indigo-500/20 focus-ring"
            >
              Get Started
            </button>
          </div>
