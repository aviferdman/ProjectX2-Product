...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      /* 2 */ {
        description: 'Escalation triage discussion — decide which tickets need human intervention',
    ...
    >
      ...
      <section className="pt-16 pb-10 text-center px-6">
        ...
        <p className="text-base text-[var(--cs-text-secondary)] max-w-xl mx-auto leading-relaxed">
          Pre-built team configurations with specialized agents and workflows. Pick a template and
      ...
      <div className="max-w-5xl mx-auto w-full px-6 mb-8">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
          ...
          <div className="relative flex-1">
            <svg
              className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--cs-text-tertiary)] pointer-events-none"
              width="16"
              height="16"
              viewBox="0 0 24 24"
              fill="none"
      ...
      {activeCategory === 'All' && !search.trim() && (
        <section className="max-w-5xl mx-auto w-full px-6 mb-10">
          <p className="text-xs uppercase tracking-wider text-[var(--cs-text-tertiary)] mb-4 font-medium">
            Featured
          </p>
      ...
      <section className="max-w-5xl mx-auto w-full px-6 pb-20">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-[var(--cs-text-tertiary)] text-sm">
    ...
    <div className="group relative rounded-2xl border border-[var(--cs-border-default)] bg-white/[0.02] hover:bg-white/[0.05] hover:border-[var(--cs-border-hover)] transition-all duration-200 overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <span className="shrink-0 text-[10px] text-[var(--cs-text-tertiary)] tabular-nums mt-1">
    ...
    <div className="group flex flex-col rounded-xl border border-[var(--cs-border-subtle)] bg-white/[0.02] hover:bg-white/[0.05] hover:border-[var(--cs-border-default)] transition-all duration-200 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 p-5">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[10px] text-[var(--cs-text-tertiary)] tabular-nums">
            {template.usageCount.toLocaleString()} uses
          </span>
        </div>
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {template.tags.slice(0, 3).map((tag) => (
            <span
              key={tag}
              className="text-[10px] px-1.5 py-0.5 rounded-md bg-white/[0.04] text-[var(--cs-text-tertiary)] border border-[var(--cs-border-subtle)]"
            >
              {tag}
            </span>
          ))}
