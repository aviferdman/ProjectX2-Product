...
export const timelineTheme = {
  colors: {
    timeline: {
      ...
      'axis-grid': 'rgba(113,113,122,0.06)',
      playhead: '#818cf8',
      'playhead-glow': 'rgba(99,102,241,0.3)',
      'selection-range': 'rgba(99,102,241,0.1)',
      'selection-border': '#818cf8',
    },
    event: {
      llm: {
    ...
    log: {
      ...
      'row-bg-selected': 'rgba(99,102,241,0.1)',
  ...
  keyframes: {
    'playhead-pulse': {
      '0%, 100%': { boxShadow: '0 0 4px 0 rgba(99,102,241,0.3)' },
      '50%': { boxShadow: '0 0 10px 3px rgba(99,102,241,0.3)' },
    },
    'event-enter': {
