...
export const workflowCardListTheme = {
  colors: {
    'wf-card': {
      ...
      'bg-selected': 'rgba(139,92,246,0.06)',
    ...
    'wf-bulk': {
      ...
      'btn-bg-hover': 'rgba(148,163,184,0.15)',
  ...
  fontSize: {
    ...
    'wf-status-badge': ['0.625rem', { lineHeight: '1', fontWeight: '600', letterSpacing: '0.05em' }],
    'wf-action-item': ['0.8125rem', { lineHeight: '1.25', fontWeight: '400' }],
    'wf-avatar-overflow': ['0.5625rem', { lineHeight: '1', fontWeight: '500' }],
    'wf-list-header': ['0.6875rem', { lineHeight: '1', fontWeight: '600', letterSpacing: '0.05em' }],
    'wf-list-name': ['0.8125rem', { lineHeight: '1.25', fontWeight: '500' }],
    'wf-list-subtitle': ['0.6875rem', { lineHeight: '1.25', fontWeight: '400' }],
  },

  boxShadow: {
    'wf-card': '0 1px 3px rgba(0,0,0,0.3), 0 0 0 1px rgba(148,163,184,0.06)',
    'wf-card-hover': '0 4px 12px rgba(0,0,0,0.4), 0 0 0 1px rgba(148,163,184,0.1)',
    'wf-card-selected': '0 0 0 2px rgba(139,92,246,0.5), 0 4px 12px rgba(0,0,0,0.3)',
    'wf-action-menu': '0 4px 24px rgba(0,0,0,0.5), 0 0 0 1px rgba(148,163,184,0.1)',
