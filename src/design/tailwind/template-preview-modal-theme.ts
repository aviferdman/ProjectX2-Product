...
export const templatePreviewModalTheme = {
  colors: {
    ...
    'pm-diagram': {
      ...
      'node-agent-bg': 'rgba(124,58,237,0.15)',
      'node-agent-border': '#8b5cf6',
      'node-agent-icon': '#a78bfa',
      'node-task-bg': 'rgba(14,165,233,0.15)',
      'node-task-border': '#0ea5e9',
      'node-task-icon': '#38bdf8',
    ...
    'pm-sidebar': {
      ...
      'avatar-bg': 'rgba(139,92,246,0.15)',
      'avatar-text': '#c4b5fd',
    ...
    'pm-use-btn': {
      ...
      'bg-hover': '#8b5cf6',
      'bg-active': '#6d28d9',
      'bg-disabled': 'rgba(124,58,237,0.3)',
      text: '#ffffff',
  ...
  boxShadow: {
    'pm-modal':
      '0 24px 48px rgba(0,0,0,0.5), 0 0 0 1px rgba(148,163,184,0.08)',
    'pm-node': '0 1px 4px rgba(0,0,0,0.3)',
    'pm-use-btn': '0 2px 8px rgba(124,58,237,0.35)',
    'pm-use-btn-hover': '0 4px 12px rgba(124,58,237,0.45)',
    'pm-focus-ring': '0 0 0 3px rgba(139,92,246,0.25)',
  },
